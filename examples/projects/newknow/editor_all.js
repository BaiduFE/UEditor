...
//                }
        ...
        clearEmptySibling : function( node, ingoreNext, ingorePre ) {
            function clear( next, dir ) {
                var tmpNode;
                if ( next && !domUtils.isBookmarkNode( next ) && domUtils.isEmptyInlineElement( next ) ) {
                    tmpNode = next[dir];
...
//                        }
         ...
         * @example &lt;div&gt;xxxx&lt;b&gt;aaaa&lt;/b&gt;cccc&lt;/div&gt; ==> &lt;div&gt;xxxx&lt;/div&gt;&lt;b&gt;aaaa&lt;/b&gt;&lt;div&gt;cccc&lt;/div&gt;
         */
        ...
        mergToParent : function( node ) {
            ...
            while ( parent && dtd.$removeEmpty[parent.tagName] ) {
                if ( parent.tagName == node.tagName ) {
                    ...
                    if ( parent.tagName.toLowerCase() == 'span' && parent.style.cssText != node.style.cssText ) {
...
(function() {
    ...
    Range.prototype = {
        ...
        createBookmark : function( serialize, same ) {
            ...
            startNode.style.cssText = 'overflow:hidden;line-height:0px;';
        ...
        function UndoManager() {
            ...
            this.undo = function() {
                ...
                if ( this.hasUndo ) {
                    ...
                    if ( lastScene.content != currentScene.content ) {
                        this.save();
                    }
            ...
            this.getScene = function() {
                var range = me.selection.getRange(),
                    cont = me.body.innerHTML.replace(fillchar,'').replace(/>&nbsp;</g,'><'),
        ...
        me.addListener( 'keyup', function( type, evt ) {
            ...
            if ( keyCode == 8 || keyCode == 46  ) {
                ...
                if ( domUtils.isBody( range.startContainer ) && !range.startOffset ) {
                    ...
                    if ( body.childNodes.length == 1 && body.firstChild.nodeType == 1 && body.firstChild.tagName.toLowerCase() == 'br' && me.options.enterTag == 'p') {
                        me.document.execCommand( 'formatBlock', false, '<p>' );
                        if ( browser.gecko ) {
                            range = me.selection.getRange();
                            start = domUtils.findParentByTagName( range.startContainer, 'p', true );
...
(function() {
    ...
    function getClipboardData( plain, callback ) {
        ...
        var range = this.selection.getRange(),
            ...
            //创建剪贴的容器div
            pastebin = doc.createElement( plain ? 'textarea' : 'div' );
    ...
    baidu.editor.plugins['paste'] = function() {
        ...
        var pasteplain = me.options['pasteplain']|0;
        ...
        me.addListener( 'keydown', function( type, e ) {
            ...
            if ( (e.ctrlKey || e.metaKey) && keyCode == 86 ) {//ctrl+v
                ...
                var plain = me.queryCommandState('pasteplain');
                
                getClipboardData.call( me, plain, function( div ) {
                    if ( plain ) {
                        var range = me.selection.getRange();
                        range.deleteContents();
                        range.insertNode(me.document.createTextNode(div.value));
                        range.collapse();
                        range.select();
                        ...
                        me.filter && me.filter.doFilter( div );
            ...
            if ( (e.ctrlKey || e.metaKey) && (keyCode == 88 || keyCode == 67) ) {//ctrl+x ctrl+c
